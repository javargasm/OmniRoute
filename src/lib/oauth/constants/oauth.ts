...
import { CURSOR_AGENT_CLI_VERSION } from "@omniroute/open-sse/utils/cursorAgentCliVersionConstants.ts";
...
// clientVersion pin lives in open-sse/utils/cursorAgentCliVersionConstants.ts — single source of truth.
